      ...
      <footer className="border-t border-border bg-card py-8">
        <div className="container mx-auto px-4 text-center flex flex-col items-center justify-center gap-3">
          ...
          <p className="text-xs text-muted-foreground/60 max-w-lg leading-relaxed">
            Disclaimer: Channelzz does not host, store or distribute any live stream content.
            All streams are sourced from publicly available resources on the internet.
            We only aggregate them in one place for convenience.
          </p>
